...
const valuePillars: { title: string; description: string }[] = [
  ...
  {
    title: "Integrations",
    description: "QuickBooks Online sync plus APIs for labels, receipts, and reporting.",
  },
];
    ...
    <div className="bg-gradient-to-b from-background via-muted/40 to-background text-foreground">
      <section className="relative overflow-hidden border-b">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 sm:py-20 lg:py-24">
          <div className="inline-flex items-center gap-2 self-start rounded-full border bg-background/80 px-4 py-2 text-xs font-medium uppercase tracking-[0.12em] text-muted-foreground shadow-sm backdrop-blur">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground sm:text-xl">
                ...
                logged, and traceable—without slowing down the floor.
              </p>
